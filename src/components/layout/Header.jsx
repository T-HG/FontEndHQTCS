    ...
    <header className="border-b border-slate-200/70 bg-white/50 px-4 py-4 backdrop-blur md:px-6 xl:px-8">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          <div className="flex items-center gap-3 rounded-2xl bg-slate-100/80 px-4 py-3 text-slate-400 shadow-sm">
            <FaSearch />
            <input
              type="text"
              placeholder="Tìm kiếm thuốc, đơn hàng, khách hàng..."
              className="w-[260px] bg-transparent text-sm text-slate-700 outline-none placeholder:text-slate-400"
            />
          </div>

          <div className="flex items-center gap-3">
            <button className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
