...
export default function Sidebar() {
  ...
  const staffMenu = [
    ...
    { to: '/cashier', label: 'Bán hàng', icon: <FaCashRegister /> },
    { to: '/orders', label: 'Đơn hàng', icon: <FaFileInvoiceDollar /> },
  ...
  return (
<aside className="hidden w-[280px] shrink-0 rounded-l-[32px] bg-gradient-to-b from-emerald-600 via-green-600 to-teal-500 p-5 text-white lg:flex lg:flex-col">      <div className="mb-6 flex items-center gap-3">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/20 text-xl shadow-lg backdrop-blur">
          <FaCrown />
        </div>

        <div>
          <h1 className="text-xl font-bold">Pharma Admin</h1>
